      ...
      <section className="bio">
        ...
        <div className="descricao">
          ...
          <p>Clique nos cards abaixo para conhecer os meus trabalhos publicados. Adicionei um ícone <FontAwesomeIcon size="1x" alt="ícone de premiação" icon={faAward}
            /> nos itens que tive reconhecimento em alguma premiação. É possível que alguns links estejam disponíveis apenas para assinantes do Estadão, <del>infelizmente</del>. Também tenho o <a href="./Mariana-Cunha-Frontend.pdf" target="_blank" rel="noopener noreferrer">currículo em PDF</a>, se precisar. 
          </p>
        </div>
      </section>
